...
class Shape {
    ...
    CalcArea(x, y = x) {
        if (this.#shapeName == 'square') {
            ...
            console.log(`Area of ${this.#shapeName} with radius ${x} and height ${y} is equal to ${3.14 * x * x * y} `);
        } else {
    ...
    CalcPerimeter(x, y = x) {
        if (this.#shapeName == 'square') {
            ...
            console.log(`Perimeter of ${this.#shapeName} with radius ${x} and height ${y} is equal to ${2 * 3.14 * x * y} `);
        } else {
...
class Cylindrical extends Circel {
    #hight;
    constructor(shapeName, radius) {
        super(shapeName, radius);
    }
    ...
    get calculat() {
        return (super.CalcArea(this.radius,this.#hight), super.CalcPerimeter(this.radius,this.#hight))
    }

}

const Cylindr = new Cylindrical();
Cylindr.shapeName = 'Cylindr';
Cylindr.radius = 3;
Cylindr.hight = 8;
Cylindr.calculat;

Cylindr.CalcArea(1,2)
Cylindr.CalcPerimeter(1,2)
*/
...
const Cylindr = new Cylindrical('Cylindr', 3, 8);
Cylindr.calculat;
*/
